  ...
  return (
    <div className="min-h-screen bg-[#FFFBFC] text-[#3D3040] flex flex-col justify-between">
      <div>
        ...
        <header className="relative pt-12 pb-12 px-6 sm:px-8 lg:px-12 max-w-6xl mx-auto animate-fade-in">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 border-b border-[rgba(0,0,0,0.06)] pb-8">
            <div>
              ...
              <p className="text-sm text-[#9E8E95] font-light leading-relaxed max-w-xl">
                พื้นที่จัดการระบบแกลเลอรีรูปภาพ คุณสามารถอัปโหลดรูปภาพใหม่ หรือเลือกลบรูปภาพที่ไม่ต้องการออกจากฐานข้อมูลและระบบจัดเก็บข้อมูล R2 ได้จากที่นี่
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                href="/"
                className="py-3 px-5 rounded-xl border border-[rgba(0,0,0,0.08)] text-xs sm:text-sm font-medium text-[#9E8E95] hover:text-[#3D3040] hover:bg-neutral-50 transition-all text-center flex items-center justify-center gap-1.5 cursor-pointer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
              ...
              <Link
                href="/upload"
                className="py-3 px-5 rounded-xl bg-[#F4A0B5] hover:bg-[#F4A0B5]/90 text-white text-xs sm:text-sm font-semibold shadow-[0_4px_12px_rgba(244,160,181,0.2)] transition-all flex items-center justify-center gap-1.5 cursor-pointer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
              ...
              <button
                ...
                className="py-3 px-5 rounded-xl border border-rose-200 text-xs sm:text-sm font-medium text-rose-400 hover:text-rose-500 hover:bg-rose-50 transition-all text-center flex items-center justify-center gap-1.5 cursor-pointer"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4">
        ...
        {/* Gallery with Admin mode enabled */}
        <main>
