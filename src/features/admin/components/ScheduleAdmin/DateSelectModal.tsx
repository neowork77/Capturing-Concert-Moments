...
export default function DateSelectModal({
  ...
  return (
    ...
    >
      <div
        data-lenis-prevent
        className="bg-white rounded-2xl sm:rounded-[2rem] max-w-md w-full p-4 sm:p-7 shadow-2xl border border-[rgba(0,0,0,0.06)] relative max-h-[calc(100dvh-2rem)] sm:max-h-[90vh] flex flex-col"
      ...
      >
        ...
        <div className="flex gap-4 items-center pb-4 mb-4 border-b border-[rgba(0,0,0,0.06)] flex-shrink-0">
          ...
          <div className="flex-1 min-w-0">
            <span className="px-2.5 py-0.5 rounded-full bg-[#F4A0B5]/10 text-[#F4A0B5] font-bold text-micro">
            ...
            <p className="text-xs text-[var(--ink-muted)] mt-0.5 flex items-center gap-1 font-light truncate">
              <span>📍</span>
          ...
          <button
            onClick={onClose}
            className="w-8 h-8 rounded-full border border-[rgba(0,0,0,0.08)] flex items-center justify-center text-[var(--ink-muted)] hover:text-[#3D3040] hover:bg-neutral-100 transition-colors cursor-pointer text-sm flex-shrink-0"
          >
            ✕
          </button>
        </div>
        ...
        <div
          data-lenis-prevent
          className="flex-1 min-h-[150px] overflow-y-auto no-scrollbar space-y-3 pr-1 py-1 overscroll-contain touch-pan-y [-webkit-overflow-scrolling:touch]"
        >
              ...
              >
                ...
                <div className="mb-3">
                  <div className="flex items-center gap-2 text-xs font-medium mb-1.5">
                    ...
                    <span className="text-[#C8BBC0] ml-auto text-micro">{bookedPercent}% เต็ม</span>
                  </div>
                  {/* Mini progress bar */}
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl border border-[rgba(0,0,0,0.08)] text-[var(--ink-muted)] hover:text-[#3D3040] hover:bg-neutral-100 transition-all cursor-pointer text-xs"
        ...
        <div className="mt-4 pt-3 border-t border-[rgba(0,0,0,0.06)] text-center flex-shrink-0">
          <button
            onClick={onClose}
            className="w-full py-2.5 rounded-xl border border-[rgba(0,0,0,0.1)] text-xs font-semibold text-[var(--ink-muted)] hover:bg-neutral-50 hover:text-[#3D3040] transition-all cursor-pointer"
          >
            ปิดหน้าต่าง
          </button>
        </div>
