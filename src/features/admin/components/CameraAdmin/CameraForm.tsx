...
export default function CameraForm({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-2xl sm:rounded-[2rem] max-w-lg w-full p-4 sm:p-7 shadow-2xl border border-[rgba(0,0,0,0.06)] relative max-h-[calc(100dvh-1.5rem)] sm:max-h-[90vh] flex flex-col my-auto"
          ...
          <div className="flex-1 min-h-0 overflow-y-auto pr-1.5 sm:pr-2 pb-2 space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center justify-between p-3 rounded-xl bg-[#FFFBFC] border border-[rgba(0,0,0,0.06)]">
              <div>
                ...
                <p className="text-xs text-[var(--ink-muted)] font-light">เปิดให้ลูกค้าเลือกใน LINE Flex Message</p>
              </div>
              <input
                type="checkbox"
