...
export default function AdminLogin({
  ...
  return (
    <div className="admin-ui min-h-screen bg-[#FFFBFC] flex flex-col items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-semibold text-[var(--ink-muted)] hover:text-[#F4A0B5] transition-all duration-300 group"
        >
      ...
      <div className="w-full max-w-md animate-fade-in relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-6 sm:p-8 border border-[rgba(0,0,0,0.04)] shadow-[0_8px_40px_rgb(0,0,0,0.03)]">
          <form onSubmit={handleLogin} className="space-y-5">
            {/* Username Field */}
            <div>
              <label htmlFor="admin-username" className="block text-xs font-bold text-[var(--ink-muted)] mb-2">
                ชื่อผู้ใช้งาน
              </label>
            ...
            {/* Password Field */}
            <div>
              <label htmlFor="admin-password" className="block text-xs font-bold text-[var(--ink-muted)] mb-2">
                รหัสผ่าน
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-4 flex items-center text-[#C8BBC0] hover:text-[var(--ink-muted)] transition-colors cursor-pointer"
                  tabIndex={-1}
                >
                  {showPassword ? (
        ...
        {/* Footer */}
        <p className="text-center text-micro text-[#C8BBC0] mt-6 font-light">
